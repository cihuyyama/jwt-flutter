...
exports.refreshAccessTokenHandler = exports.createExpiredSessionHandler = exports.createSessionHandler = void 0;
...
function createExpiredSessionHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const message = "Invalid email or password";
        const { email, password } = req.body;
        const user = yield (0, userService_1.findUserByEmail)(email);
        ...
        const accessToken = (0, authService_1.signExpiredAccessToken)(user);
        const refreshToken = yield (0, authService_1.signRefreshToken)({
            userId: String(user._id)
        });
        return res.send({
...
exports.createExpiredSessionHandler = createExpiredSessionHandler;
