...
exports.findSessionById = exports.signExpiredAccessToken = exports.signAccessToken = exports.signRefreshToken = exports.createSession = void 0;
...
function signRefreshToken({ userId }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const refreshToken = (0, jwt_1.signJwt)({ session: session.id }, {
            expiresIn: '5h',
        });
        return refreshToken;
    });
...
function signExpiredAccessToken(user) {
    const payload = (0, lodash_1.omit)(user.toJSON(), userModel_1.privateFields);
    const accessToken = (0, jwt_1.signJwt)(payload, {
        expiresIn: '1s'
    });
...
exports.signExpiredAccessToken = signExpiredAccessToken;
